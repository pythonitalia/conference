...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StartupConference'
        db.create_table(u'conference_startupconference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('startup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Startup'])),
            ('conference', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('tags', self.gf('tagging.fields.TagField')()),
        ))
        db.send_create_signal(u'conference', ['StartupConference'])

        # Adding model 'Startup'
        db.create_table(u'conference_startup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'conference', ['Startup'])


    def backwards(self, orm):
        # Deleting model 'StartupConference'
        db.delete_table(u'conference_startupconference')

        # Deleting model 'Startup'
        db.delete_table(u'conference_startup')
    ...
    models = {
        ...
        u'conference.startup': {
            'Meta': {'ordering': "['name']", 'object_name': 'Startup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
        ...
        u'conference.startupconference': {
            'Meta': {'ordering': "['conference']", 'object_name': 'StartupConference'},
            'conference': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'startup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['conference.Startup']"}),
            'tags': ('tagging.fields.TagField', [], {})
        },
        u'conference.talk': {
