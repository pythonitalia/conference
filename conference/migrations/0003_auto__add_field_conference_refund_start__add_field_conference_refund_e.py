...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.refund_start'
        db.add_column(u'conference_conference', 'refund_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conference.refund_end'
        db.add_column(u'conference_conference', 'refund_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.refund_start'
        db.delete_column(u'conference_conference', 'refund_start')

        # Deleting field 'Conference.refund_end'
        db.delete_column(u'conference_conference', 'refund_end')
