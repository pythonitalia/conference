...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaPartner.svg'
        db.add_column(u'conference_mediapartner', 'svg',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaPartner.svg'
        db.delete_column(u'conference_mediapartner', 'svg')
    ...
    models = {
        ...
        u'conference.mediapartner': {
            ...
            'svg': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        },
